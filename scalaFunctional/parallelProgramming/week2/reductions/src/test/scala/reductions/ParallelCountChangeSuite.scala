...
class ParallelCountChangeSuite extends FunSuite {
  ...
  test("parallel countChange with moneyThreshold should work for multi-coins") {
    def check(money: Int, coins: List[Int], expected: Int) =
  ...
  test("parallel countChange with coinThreshold should work for multi-coins") {
    def check(money: Int, coins: List[Int], expected: Int) =
  ...
  test("parallel countChange with initial money and coin threshold should work for multi-coins") {
    def check(money: Int, coins: List[Int], expected: Int) =
